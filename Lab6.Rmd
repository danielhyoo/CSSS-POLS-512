...
This is because $\bar{y}_i$ is computed using the past $y$'s. This is correlated with $\bar{\epsilon}_{it}$, which is computed using the past $\epsilon$'s \newline

Specifically, this creates bias in the LDV. If the other regressors are correlated with the LDV, then their coefficients may also be seriously biased. \newline
