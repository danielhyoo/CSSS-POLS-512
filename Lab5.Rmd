...
$$\boldsymbol{S}_{zy}-\boldsymbol{S}_{zx}\boldsymbol{\beta}=0$$
...
Can be solved analytically. But can use iterative search to find the betas and phis.

Anderson-Hsiao: uses the twice and third lagged levels as instruments.
